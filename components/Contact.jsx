...
const Contact = () => {
  return (
    <div id="contact" className="max-w-[1240px] m-auto p-4 h-screen">
      <div  className="flex flex-col items-center justify-center">
        ...
        <div className="mx-8">
                <p className="mb-4 text-center text-lg">
                  Pour toute prise de contact ou rendez-vous, veuillez remplir et envoyer ce formulaire ci-dessus ou appeler le{" "}
                    <a
                      style={{
                        fontFamily: "Raleway",
                      }}
      ...
      <form className="max-w-[600px] m-auto mb-[10 rem]">
